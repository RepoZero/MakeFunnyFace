...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth =  resources.getDrawable(R.drawable.ic_horizontal);
        mResizeDrawableHeight = resources.getDrawable(R.drawable.ic_vertical);
        mResizeDrawableDiagonal =  resources.getDrawable(R.drawable.ic_vertical);
    }
